...
export const foodTruck = {
  ...
  primaryLocation: {
    ...
    notes:
      "Usually parked off Slaughter Lane in South Austin near the Shell station. Check Instagram stories for pop ups and updated hours.",
  },
  ...
  // Vibe imagery
  vibeImages: [
    { src: "/images/bella.webp", alt: "Taco Bella's" },
    { src: "/images/food_5.webp", alt: "Taco Bella's food" },
    { src: "/images/food-6.webp", alt: "Taco Bella's food" },
    { src: "/images/menu.webp", alt: "Taco Bella's menu" },
  ],
